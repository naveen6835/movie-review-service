        ...
        <div class="row">
		  ...
		  <span id='mobsep'><br /><br /></span>
            ...
            <div class="col-md-9">
                ...
                if(!empty($_GET['name'])){
                $mName = $_GET['name'];
				        echo "<p class='lead'>&nbsp&nbsp Movie titles containing <q><strong>" . $mName . "</strong></q>: </p>";
                $con = mysqli_connect("localhost","root","root" , "root");
                $sql="SELECT * FROM Movies WHERE title REGEXP '[[:<:]]" . $mName . "[[:>:]]'";
                $result = mysqli_query($con,$sql);
                $row_num = mysqli_num_rows($result);
                if($row_num == 0){
                  //echo "<p class='lead'>&nbsp</p>";
                  echo "<div class='alert alert-warning'>";
                  echo "Your search <q><strong>" . $mName . "</strong></q> did not match any movies!";
                  echo "</div>";
                }
                while($row = mysqli_fetch_array($result)){
                  ...
                  echo "<p class='lead'>&nbsp</p>";
                  echo "<div class='alert alert-warning'>";
                  echo "Enter a <strong>keyword</strong> or a <strong>movie name</strong>.";
                  echo "</div>";
                }
                ?>
            </div>
